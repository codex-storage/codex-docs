...
| # (0.0.1)| Protocol | Function                                                                 | CLI option       | Example                                |
| - | -------- | ------------------------------------------------------------------------ | ---------------- | -------------------------------------- |
...
### (0.0.1)Run as a service in Linux
...
### (0.0.1)Run as a service in Windows
...
1. Create `docker-compose.yaml` file:
    ...
    services:
      codex:
        ...
        ports:
          - 8080:8080/tcp # (0.0.1)API
          - 8090:8090/udp # (0.0.1)Discovery
          - 8070:8070/tcp # (0.0.1)Transport
        volumes:
          - ./datadir:/datadir
        logging:
          driver: json-file
...
#### (0.0.1)Determine your private IP
